...
references:
  ...
  - type: paper
    ...
    annotation: >-
      Defines the Triple Debt Model — Technical, Cognitive, and Intent Debt —
      positioning vibe coding as the primary generator of all three debt types.
  - type: paper
    title: >-
    ...
    annotation: >-
      ...
      bypassing both intuition and deliberate reasoning. The psychological
      mechanism behind vibe coding's failure modes.
---
> **ASDLC Knowledge Base** | Status: Live | [View Online](https://asdlc.io/concepts/vibe-coding)
...
- [Triple Debt Model](../concepts/triple-debt-model.md) — Diagnostic framework for the debt vibe coding generates
