...
references:
  ...
  - type: paper
    ...
    annotation: >-
      Evolving evaluation criteria at checkpoints re-ranks the search archive,
      imposing a curriculum-like effect.
---
