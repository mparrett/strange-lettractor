...
references:
  ...
  - type: website
    ...
    annotation: >-
      The Linux kernel's official policy on AI-assisted contributions.
      Formalizes human-only DCO sign-off and the Assisted-by attribution tag — a
      level-invariant governance principle where individual commits may be
      agent-assisted but the program increment requires human accountability.
  - type: paper
    title: >-
    ...
    annotation: >-
      Defines Intent Debt — the absence of externalized rationale and
      constraints. Provenance is one enforcement mechanism for reducing Intent
      Debt, not its full scope.
---
> **ASDLC Knowledge Base** | Status: Live | [View Online](https://asdlc.io/concepts/provenance)
...
Linus Torvalds famously said, "Talk is cheap. Show me the code." In the AI era, this inverts: **Code is cheap. Show me the talk.** "The Talk" is the [Spec](../patterns/the-spec.md) — the high-fidelity articulation of requirements, constraints, and architecture.
...
- [Triple Debt Model](../concepts/triple-debt-model.md) — Diagnostic framework positioning Provenance within Intent Debt mitigation
- [Artifact Import](../patterns/artifact-import.md) — Establishes provenance for artifacts crossing the enterprise perimeter
