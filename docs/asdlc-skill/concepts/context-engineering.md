...
references:
  ...
  - type: paper
    ...
    annotation: >-
      Introduces the ReAct paradigm, demonstrating that interleaving reasoning
      traces and environment observations grounds context and mitigates
      hallucinations.
---
