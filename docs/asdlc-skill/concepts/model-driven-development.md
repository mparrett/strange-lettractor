...
description: >-
  An early 2000s software engineering paradigm that attempted 100% code
  generation from models, serving as a cautionary tale for modern spec-as-source
  AI hype.
tags:
...
references:
  - type: website
    ...
    annotation: >-
      Highlights the risks of 'spec-as-source' by comparing it to the failed
      Model-Driven Development (MDD) paradigms.
---
> **ASDLC Knowledge Base** | Status: Live | [View Online](https://asdlc.io/concepts/model-driven-development)
...
1. **Specs are for Intent:** We write [Living Specs](../practices/living-specs.md) to define architectural boundaries, invariants, and accepted behavior.
...
> **Read Next:** Learn how ASDLC navigates these pitfalls in [Spec-Driven Development](../concepts/spec-driven-development.md).
