...
title: Gherkin
description: >-
  A structured, domain-specific language using Given-When-Then syntax to define
  behavioral specifications that are both human-readable and machine-actionable.
tags:
  - Testing
  - Specification
  - BDD
...
---
> **ASDLC Knowledge Base** | Status: Live | [View Online](https://asdlc.io/concepts/gherkin)
...
Gherkin is a structured, domain-specific language using Given-When-Then syntax to define behavioral specifications in plain text. While [Behavior-Driven Development](../concepts/behavior-driven-development.md) provides the methodology, Gherkin provides the concrete syntax.
...
**In Specs:** The [Spec](../patterns/the-spec.md) Contract section uses Gherkin scenarios:
...
**Applied in:**
- [The Spec](../patterns/the-spec.md) — Contract section uses Gherkin scenarios
- [Context Gates](../patterns/context-gates.md) — Gherkin scenarios define gate verification criteria
- [Living Specs](../practices/living-specs.md) — Gherkin scenarios evolve with the feature
