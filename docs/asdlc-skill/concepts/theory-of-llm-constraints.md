...
description: >-
  Applying Goldratt's Theory of Constraints to AI delivery. Coding-side speed
  shifts bottlenecks downstream; the ASDLC answer is proportional verification
  from a minimal context-specific scaffold.
tags:
  - Theory
  - Productivity
  - Metrics
...
references:
  - type: website
    ...
    url: >-
      https://www.linkedin.com/pulse/theory-llm-constraints-mats-ljunggren-qmzde/
    published: 2026-05-12T00:00:00.000Z
    accessed: 2026-05-18T00:00:00.000Z
    annotation: >-
      Applies Goldratt's Theory of Constraints to LLM-augmented delivery;
      synthesizes Faros, Thoughtworks, DORA, and METR telemetry into the
      bottleneck-shift thesis.
  - type: website
  ...
  - type: website
    ...
    author: Thoughtworks
    url: >-
      https://www.thoughtworks.com/en-us/insights/blog/generative-ai/how-faster-coding-assistants-software-delivery
    published: 2025-02-01T00:00:00.000Z
    accessed: 2026-05-18T00:00:00.000Z
    annotation: >-
      Empirical decomposition: ~30% coding acceleration yields ~8% net delivery
      improvement because coding is roughly half of cycle time.
  - type: website
    ...
    accessed: 2026-05-18T00:00:00.000Z
    annotation: >-
      First official benchmarks for Deployment Rework Rate, the 5th DORA metric
      — the quality-leakage signal complementing PR Cycle Time.
  - type: website
    title: >-
    ...
    accessed: 2026-05-18T00:00:00.000Z
    annotation: >-
      RCT finding experienced open-source developers were 19% slower with AI
      tools while perceiving themselves as faster. Counter-evidence to
      perceived-acceleration claims.
---
> **ASDLC Knowledge Base** | Status: Experimental | [View Online](https://asdlc.io/concepts/theory-of-llm-constraints)
...
This is the [Faster Horse Fallacy](../concepts/agentic-sdlc.md). It optimizes the broken station rather than redesigning the line. The ASDLC accepts Goldratt's *diagnostic* and rejects his *classical cure*:

| Step | Classical TOC remediation | ASDLC structural remediation |
|---|---|---|
| Identify | Coding is no longer the constraint; review is. | Same. |
| Exploit | Squeeze every drop from existing reviewers. | Reduce review surface via [Micro-Commits](../practices/micro-commits.md) and [Specs](../patterns/the-spec.md). |
| Subordinate | Cap upstream PR generation to match review capacity. | Cap *unverified* generation; let verified generation run. |
| **Elevate** | **Add reviewers, parallelize review, AI-assist review.** | **Replace peer review with inspection stations** — [Adversarial Code Review](../practices/adversarial-code-review.md), [Context Gates](../patterns/context-gates.md), [Constitutional Review](../practices/constitutional-review-implementation.md). |
| Repeat | When review is no longer the constraint, find the next one. | Same — production observability via [Feedback Loop Compression](../concepts/feedback-loop-compression.md). |

The substitution at *Elevate* is the entire point. Adding reviewers is linear; structural verification is multiplicative. This is the same position [PR Slop](../concepts/pr-slop.md) takes from a different angle: "PR slop cannot be solved by reviewing harder."
...
See also: [Feedback Loop Compression](../concepts/feedback-loop-compression.md) (the OODA-framed view of the same shift), [PR Slop](../concepts/pr-slop.md) (the quality-leakage manifestation), [AI Amplification](../concepts/ai-amplification.md) (why bad processes amplify under AI), [Context Gates](../patterns/context-gates.md) (how proportional gates are layered in practice).
