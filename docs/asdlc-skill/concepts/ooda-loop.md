...
description: >-
  The OODA Loop (Observe-Orient-Decide-Act) is a decision-making framework by
  John Boyd. Learn how it applies to software development and autonomous AI
  agents.
tags:
  - AI
  - Agent Architecture
...
references:
  ...
  - type: paper
    ...
    annotation: >-
      Foundational paper introducing the Thought-Action-Observation prompting
      loop.
---
