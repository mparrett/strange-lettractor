...
description: >-
  A lightweight document that captures a significant architectural decision, its
  context, and consequences at a specific point in time.
tags:
  - Architecture
  - Documentation
  - Decision Making
...
---
> **ASDLC Knowledge Base** | Status: Live | [View Online](https://asdlc.io/concepts/architecture-decision-record)
...
ADRs may also evolve into [Agent Constitution](../patterns/agent-constitution.md) rules—an ADR stating "All database migrations must be backward-compatible" becomes a constitutional constraint that agents must not violate.

Applied in:
- [The ADR](../patterns/the-adr.md) — Structural pattern for ADR anatomy
- [ADR Authoring](../practices/adr-authoring.md) — Practical guide for writing ADRs
- [Request for Comments](../concepts/request-for-comments.md) — Related concept for grouped proposals

See also:
- [The Spec](../patterns/the-spec.md) — Living documentation that ADRs inform but do not replace
