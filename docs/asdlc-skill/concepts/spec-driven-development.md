...
references:
  - type: website
    ...
    annotation: >-
      Defines a 6-phase SDD lifecycle and introduces three industry frameworks
      (BMad, spec-kit, OpenSpec) that enforce it.
  - type: website
  ...
  - type: repository
    ...
    annotation: >-
      Persona-driven agent orchestration framework (Analyst, Architect,
      Developer, QA) utilizing structured templates to enforce phase handoffs.
  - type: repository
    title: OpenSpec
    url: 'https://github.com/openspec-ai/openspec'
    annotation: >-
      Document-first SDD framework utilizing versioned, schema-validated
      Markdown specifications validated via CI checks.
---
