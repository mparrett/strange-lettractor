...
- [The Spec](../patterns/the-spec.md) — The artifact this pattern produces
- [Artifact Import](../patterns/artifact-import.md) — Composes with Spec Reversing to bring frontier capability into regulated brownfield environments via the reversed spec
