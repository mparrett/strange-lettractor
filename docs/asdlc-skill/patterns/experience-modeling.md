...
description: >-
  The practice of treating the Design System as a formal schema that agents must
  strictly follow, preventing UI hallucinations.
tags:
  - ASDLC
  - Design System
  - Methodology
...
---
> **ASDLC Knowledge Base** | Status: Live | [View Online](https://asdlc.io/patterns/experience-modeling)
...
A mechanical barrier between Experience Modeling and [Feature Assembly](../practices/feature-assembly.md).
...
**[Context Gates](../patterns/context-gates.md)** — Experience Modeling implements a specific type of Context Gate: the "Design Integrity Gate."

**[Feature Assembly](../practices/feature-assembly.md)** — The phase that *consumes* the Experience Model. Feature Agents assume the Experience Model is immutable context.

**[Agent Personas](../practices/agent-personas.md)** — We often use a specific "Systems Architect" or "Designer" persona for the Experience Modeling phase, distinct from the "Feature Developer" persona.
