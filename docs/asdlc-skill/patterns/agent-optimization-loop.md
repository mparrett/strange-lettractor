...
references:
  ...
  - title: 'The Red Queen Gödel Machine: Co-Evolving Agents and Their Evaluators'
    ...
    annotation: >-
      Introduces the Red Queen Gödel Machine (RQGM) and controlled utility
      evolution.
---
...
A key limitation of standard self-improvement loops is that static evaluation criteria (scenarios or judges) become stale or prone to gaming (Goodhart's Law) as the agent's capabilities improve. The [Red Queen Gödel Machine](../concepts/red-queen-godel-machine.md) (Iacob et al., 2026) addresses this by **co-evolving the evaluator alongside the task agent** under non-stationary utility signals. 
