...
description: >-
  A computational framework transforming the classic design thinking model into
  an executable pipeline of context verification and assembly.
tags:
  - Design
  - Methodology
  - Requirements
...
references:
  - title: The Double Diamond
    ...
    url: >-
      https://www.designcouncil.org.uk/our-work/skills-learning/tools-frameworks/framework-for-innovation-design-council-s-evolved-double-diamond/
    type: website
  ...
  - title: 'Before I Ask AI to Build, I Ask It to Challenge'
    ...
    url: >-
      https://danieldonbavand.com/2026/02/12/before-i-ask-ai-to-build-i-ask-it-to-challenge/
    type: website
  ...
  - title: AI-Driven Development Framework
    ...
    type: website
    annotation: >-
      A practical implementation of the Agentic Double Diamond using GitHub
      Copilot showing a 30-40% speed increase.
    accessed: 2026-02-25T00:00:00.000Z
lastUpdated: 2026-02-25T00:00:00.000Z
status: Experimental
---
> **ASDLC Knowledge Base** | Status: Experimental | [View Online](https://asdlc.io/patterns/agentic-double-diamond)
...
*   **Practices:**
    *   **[Experience Modeling](../patterns/experience-modeling.md)**: Defining the domain language and user journey.
    *   **[Context Engineering](../concepts/context-engineering.md)**: Structuring the raw input for analysis.
...
*   **Gate 1 (The Checkpoint):** **[Adversarial Requirement Review](../practices/adversarial-requirement-review.md)**.
...
**Context Output:** **[The Spec](../patterns/the-spec.md)** (Context, Blueprint, Contract).

*   **Practices:**
    *   **[Spec-Driven Development](../concepts/spec-driven-development.md)**: The methodology of writing specs first.
    *   **[Living Specs](../practices/living-specs.md)**: Treating documentation as code.
...
*   **Gate 2 (The Checkpoint):** **[Adversarial Code Review](../practices/adversarial-code-review.md)**.
    ...
    *   See also: **[Micro-Commits](../practices/micro-commits.md)** and **[Feature Assembly](../practices/feature-assembly.md)**.
...
*   **Practices:**
    *   **[Feedback Loop Compression](../concepts/feedback-loop-compression.md)**: Minimizing the time between "Run" and "Discover".
    *   **[Production Readiness Gap](../concepts/production-readiness-gap.md)**: Managing the transition from prototype to production.

## Relationship to Other Patterns

*   **[Product Thinking](../concepts/product-thinking.md)**: The mindset that drives the *Discover/Define* phases.
*   **[The Spec](../patterns/the-spec.md)**: The central artifact connecting *Define* to *Assemble*.
*   **[Agent Constitution](../patterns/agent-constitution.md)**: The set of laws that govern agent behavior throughout the pipeline.
*   **[Context Gates](../concepts/context-gates.md)**: The architectural pattern implemented by the Adversarial Reviews.
