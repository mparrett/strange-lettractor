...
description: >-
  Structural pattern where each cycle produces both an artifact and candidate
  learnings, gated by a human reviewer before persistence to specialized,
  JIT-fetchable context artifacts.
tags:
  - Agent Architecture
  - Iteration
  - Context Engineering
...
---
> **ASDLC Knowledge Base** | Status: Live | [View Online](https://asdlc.io/patterns/compound-loop)
